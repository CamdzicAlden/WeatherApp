...
const weatherCategories = {
  clear: [1000, 0, 1],
  cloudy: [
    2, 3, 45, 48, 51, 53, 55, 56, 57, 1003, 1006, 1009, 1030, 1135, 1147,
  ],
  rain: [
    61, 63, 65, 66, 67, 80, 81, 82, 1063, 1072, 1150, 1153, 1168, 1171, 1180,
    1183, 1186, 1189, 1192, 1195, 1198, 1201, 1240, 1243, 1246,
  ],
  snow: [
    71, 73, 75, 77, 85, 86, 1066, 1069, 1114, 1117, 1204, 1207, 1210, 1213,
    1216, 1219, 1222, 1225, 1237, 1249, 1252, 1255, 1258, 1261, 1264,
  ],
  storm: [1087, 95],
  rainStorm: [1273, 1276, 1279, 1282, 96, 99],
};
