...
function TodaysForecast({ todaysForecast, isFullMoon, loading }) {
  ...
  return (
    //Main flex container
    <div className="flex flex-col justify-evenly items-center w-[95dvw] h-[32vh] lg:w-[50dvw] lg:h-[35vh] rounded-[clamp(2rem,4dvw,10rem)] bg-[#1453B6] mx-auto my-[3%] px-[5%] lg:px-[1%] py-[1.5%] text-[#fafafa] shadow-[0_clamp(0.1rem,0.5vh,2rem)_clamp(0.1rem,1vh,10rem)_rgba(0,0,0,0.25)]">
