...
function BackgroundCircle({ top = 0, left = 0 }) {
  ...
  const classes = `fixed drop-shadow-[0_0.2rem_0_rgba(0,0,0,0.05)] blur-[0.10dvw] -translate-x-1/2 -translate-y-1/2 w-[clamp(13rem,20vw,20rem)] h-[clamp(13rem,20vw,20rem)]`;
  return (
    //Svg container
    <svg
      viewBox="0 0 200 200"
